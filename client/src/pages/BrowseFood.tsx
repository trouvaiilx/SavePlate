...
import { Search, SlidersHorizontal, CheckCircle, HeartHandshake, UtensilsCrossed, MapPin, Clock, User, Package, X, ChevronRight } from 'lucide-react';
              ...
              {filteredDonations.map(d => {
                ...
                return (
                  <div key={d.donation_id} className="border border-border p-4 hover:border-primary/40 transition-colors">
                    ...
                    <button className="w-full mt-3 h-10 border border-primary text-primary text-sm font-semibold hover:bg-primary hover:text-primary-foreground active:bg-primary/90 transition-colors flex items-center justify-center gap-1.5">
